...
@Entity
@Table(name = "tblcurrentorder")/*, indexes = {
...
public class ContactStore implements Serializable, OrderEntity {

    private static final long serialVersionUID = -2415961428794109396L;
    ...
    @Column(name = "OrderNo", unique = true, length = 50)
    ...
    @Column(name = "Margin", precision = 45)
    ...
    @Column(name = "contact_number", precision = 10)
    ...
    /**
     * Compares the key for this instance with another CurrentOrder.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class CurrentOrder and the key objects are
     *         equal
     */
    ...
    /**
     * Compares this instance with another CurrentOrder.
     *
     * @param other The object to compare to
 ...
 /*   @Override
    public boolean equals(Object other) {
        if (!(other instanceof CurrentOrder))
            return false;
        return this.equalKeys(other) && ((CurrentOrder) other).equalKeys(this);
    } */
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[CurrentOrder |");
